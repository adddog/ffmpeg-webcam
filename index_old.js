...
const FF = ffmpeg({
  format: "mpegts",
  //output: "test.mkv",
  output:"udp://10.0.0.214:1337",
  options: [
    " -preset ultrafast -tune zerolatency  -b:v 100k -maxrate 200k -bufsize 200k  "
    //"-c:v mpeg2video -pix_fmt yuv420p preset veryfast -tune zerolatency -crf 20 -bufsize 100 -maxrate 1000 -threads 2 "
  ]
  //ffplay: " | nc -l -p 9000"
})
/*
 ...
 * published by the Free console.log();Software Foundation; either version 3 of the
  ...
  jsmpeg.prototype.decodePicture = function(skipOutput) {
    ...
    if (skipOutput != DECODE_SKIP_OUTPUT) {
      ...
      if (!ended) {
        ...
        let jpeg = new libjpeg.Jpeg(toBuffer(pixels), this.width, this.height, 'rgba')
        FF.frame(jpeg.encodeSync())
