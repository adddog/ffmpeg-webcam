    ...
    return gl({
      ...
      frag: `
          ...
          void main() {
            ...
            //wiggleCoord.x = wiggleCoord.x + mod((multi * 0.03 - 0.015), 0.01);
            //wiggleCoord.y = wiggleCoord.y + mod((multi * 0.03 - 0.015), 0.01);
            ...
            vec3 koColor = keyColor + multiSmall;
            float ff = chromaKeyAlphaTwoFloat(knockoutC, koColor, 1. - (tolerance + multiSmall), slope);

            vec3 color = mix(c0, c1, ff);

            //float ff2 = chromaKeyAlphaTwoFloat(color, 1. - keyColor, tolerance , 0.2);
